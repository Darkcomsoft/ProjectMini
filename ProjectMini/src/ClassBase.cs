...
namespace ProjectSLN.darkcomsoft.src
{
    public abstract class ClassBase : IDisposable
    {
        ...
        /// <param name="msg"></param>
        /// <param name="caller"></param>
        protected static void printWarning(string msg, string caller = "") { Debug.Warning(msg, caller); }
        /// <summary>
        /// Used for print Errors in console and debug, is the same of <see cref="Debug.LogError(string, string)"/>
        /// </summary>
        /// <param name="msg"></param>
        /// <param name="caller"></param>
        protected static void printError(string msg, string caller = "") { Debug.Error(msg, caller); }
